...
namespace iQuest.OneHundred.Presentation
{
    public sealed class JobsView : IDisposable
    {
        ...
        public void DisplayProblemInfo(uint threadCount, ulong incrementCount)
        {
            ...
            CustomConsole.WriteLineEmphasies("This application creates multiple threads that increment the same variable.");
            CustomConsole.WriteLine();
            ...
            CustomConsole.WriteLine(ConsoleColor.DarkYellow, "{0:N0}", threadCount * incrementCount);
        }
